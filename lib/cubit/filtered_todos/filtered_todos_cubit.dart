...
class FilteredTodosCubit extends Cubit<FilteredTodosState> {
  ...
  changeTodoFiltered() {
    List<TodoModel> filteredTodoVar = [];
    ...
    if (todoSearchCubit.state.searchText.isNotEmpty) {
      filteredTodoVar = filteredTodoVar
          .where((T) =>
              T.title.contains(todoSearchCubit.state.searchText) ||
              T.categori.contains(todoSearchCubit.state.searchText) ||
              T.notes.contains(todoSearchCubit.state.searchText))
          .toList();
    }
